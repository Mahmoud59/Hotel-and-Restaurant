...
<form method="post" action="<?= base_url()?>Project/kill_room/<?php echo $value->room_id; ?>"><div class="body-content">
  <div class="module" style="line-height: 1px">
	...
	<input type="submit" value="Confirm Check out" name="register" class="btn btn-block btn-primary" />
	</div>
</div>
</form>	
<?php endforeach?>
